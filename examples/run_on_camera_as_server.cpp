...
int main() {
  ...
  std::vector<std::string> body_names{"dizuo", "da_chilun", "xiao_chilun", "gaizi", "da_gaizi_hou", "xiao_gaizi_hou"};
  // std::vector<std::string> body_names{"xiao_chilun"};
  ...
  constexpr bool kSaveImages = true;
  ...
  for (const auto body_name : body_names) {
    ...
    // std::cout << detector_ptr->name() << std::endl;
  ...
  if (!tracker_ptr->RunTrackerProcessOneByOne(true, false)) return 0;


  // std::cout << depth_camera_ptr->depth_scale() << std::endl;
  // std::cout << depth_camera_ptr->image_scale() << std::endl;
  // std::cout << depth_camera_ptr->color2depth_pose()->matrix() << std::endl;
  // std::cout << depth_camera_ptr->depth2color_pose()->matrix() << std::endl;
