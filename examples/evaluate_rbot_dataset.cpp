...
int main() {
  // Directories
  std::filesystem::path dataset_directory{"./rbot/dataset/"};
  std::filesystem::path external_directory{"./rbot/external/"};
  std::filesystem::path result_directory{"./rbot/result/"};
