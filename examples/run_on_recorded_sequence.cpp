...
//     return 0;
//   }
  const std::filesystem::path color_camera_metafile_path{"./save/color_camera.yaml"};
  const std::filesystem::path body_metafile_path{"./generator_example/triangle.yaml"};
  const std::filesystem::path detector_metafile_path{"./generator_example/triangle_manual_detector.yaml"};
